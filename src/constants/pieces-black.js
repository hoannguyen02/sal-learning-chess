...
export const BLACK_PIECES = [
  ...
  // Rook
  { prevPosition: null, position: [0, 0], line: 0, type: PieceType.ROOK },
  { prevPosition: null, position: [0, 7], line: 0, type: PieceType.ROOK },
  // Knight
  { prevPosition: null, position: [0, 1], line: 0, type: PieceType.KNIGHT },
  { prevPosition: null, position: [0, 6], line: 0, type: PieceType.KNIGHT },
  // Bishop
  { prevPosition: null, position: [0, 2], line: 0, type: PieceType.BISHOP },
  { prevPosition: null, position: [0, 5], line: 0, type: PieceType.BISHOP },
  // Queen
  { prevPosition: null, position: [0, 3], line: 0, type: PieceType.QUEEN },
  { prevPosition: null, position: [0, 4], line: 0, type: PieceType.KING },
];
